...
namespace MoGUI
{
    public class MoGuiPanel : MoGuiControl
    {
        ...
        public MoGuiPanel(MoGuiMeta meta, string name, MoGuiPanel owner) : base(meta, name)
        {
            Panel = owner;
            Init();
        }
        ...
        public virtual void Init(GameObject canvas, string name, Vector2 size, Vector2 pos, bool topLevel = false)
        {
            ...
            if (topLevel)
            {
                ...
                Header = new MoGuiHeader(Meta, canvas, this, name);
        ...
        public virtual void Init( string name, Vector2 size, Vector2 pos, bool topLevel = false)
        {
            ...
            if (topLevel)
            {
                ...
                Header = new MoGuiHeader(Meta, Obj, this, name);
                Header.Obj.transform.SetParent(Obj.transform, false);
            }
            is_init = true;
        }
        ...
        public GameObject CreateColumn( string row, string name)
        {
            ...
            layoutObject.transform.SetParent(Container.transform, false);
            VerticalLayoutGroup layoutGroup = layoutObject.AddComponent<VerticalLayoutGroup>();
        ...
        private MoGuiControl CreateComponent(string name, MoGCArgs args)
        {
            ...
            else if (args.Type == typeof(MoGuiToggle))
            {
                ...
                return new MoGuiToggle(_args.Meta ?? Meta, Name + "_" + name, _args.Value, _args.Text, _args.OnClickAction);
            }
            ...
            else if (args.Type == typeof(MoGuiSlider))
            {
                ...
                return new MoGuiSlider(_args.Meta ?? Meta, Name + "_" + name, _args.Text, _args.Range, _args.OnUpdateAction, _args.OnEditAction, _args.ValType);
            }
            ...
            else if (args.Type == typeof(MoGuiPanel))
            {
                ...
                return new MoGuiPanel(_args.Meta ?? Meta, Name + "_" + name, this);
            }
            else
            {
                MoCaText _args = (MoCaText)args;
    ...
    public class MiniUIRow
    {
        ...
        private GameObject CreateRow()
        {
            ...
            rowObj.transform.SetParent(_parent.Container.transform);
            return rowObj;
        }
    ...
    public class MoGuiHeader : MoGuiPanel
    {
        ...
        public MoGuiHeader(MoGuiMeta meta, GameObject canvas, MoGuiPanel panel, string name) : base(meta, name, panel)
        {
        ...
        public void AddResize()
        {
            ...
            //Image resizeIconImage = resizeIconObject.AddComponent<Image>();
            // resizeIconImage.sprite = ResizeIconSprite;
            //resizeIconImage.color = new Color(0.1f, 0.1f, 0.1f, 0.1f);
